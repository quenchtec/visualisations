...
function handlelinkchecks() {
    ...
    window.location.href = `https://survey.crestadvisory.com/XRcDS9?reurl=${window.location.href}`;
    console.log("where to go", window.location.href, "  globalLink", globalLink);
}
