function rsVisScrollingGrid(rsQno, rsSubqIndex, rsParams) {
    ...
    const gridType = ($(".cTable ").hasClass("rsMultiGrid")) ? "Multi" : "Single";
    ...
    //Build buttons
    buildScrollingGridButtons(QuestionID, intNumButtons, intNumButtonsPrRow, intSpecialButtons, btnDivID, btnDivIDattr, rsParams, gridType);
...
function buildScrollingGridButtons(QuestionID, intNumButtons, intNumButtonsPrRow, intSpecialButtons, btnDivID, btnDivIDattr, rsParams, gridType) {
    let strHTML = "";
    ...
    strHTML = `<div id="${btnDivIDattr}" class="rsFlexBtnContainer rsBtnGrid${gridType}" width="100%">`;
